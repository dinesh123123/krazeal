...
const Product_api=async(req,res)=>{
    const {product_name,category_name,title,text,price,discount_price,discount_percantage,delevery_time,refund_pollicy,
                 category_id,instock,dimensions,type_product,type_of_finish,offer,height,width,length,description}=req.body;
try{
...
const sizes=["single","double","queen size","king size","five","four"];
    ...
    const product=new Product({product_name,category_name,title,text,discount_price,discount_percantage,delevery_time,refund_pollicy,
                               color:colors,size:sizes,category_id,instock,
                               dimensions,type_product,type_of_finish,images:arrayImage,offer,height,width,length,description});
